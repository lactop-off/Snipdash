...
Read `要件定義.md` + `基本設計.md` + `CLAUDE.md` (especially **Rust⇄TS lockstep**, **schema versioning & persistence**, **trust boundary**) + `docs/AI開発プロセス.md`.
...
2. **詳細設計** — write `docs/work/<feature>/詳細設計.md`:
...
Output: write `詳細設計.md`, return a summary + path + an explicit **feasibility verdict (OK / NG + reasons)**.
